...
1. Add your own company logo to the landing page by using this shortcode parameter: [clinked_portal **logo="logo image url"**]
2. Change the landing page wallpaper using this shortcode parameter: [clinked_portal **wallpaper="wallpaper image url"**]
